						...
						if(category == CONST_PARAM.ONETIME){
										...
										if(email_type == CONST_PARAM.BASIC){
											...
											if(!!mandrill_credentials.api_key){
												if(!!from_email && !!to_email && !!subject){
													...
													message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:basic_unique_string});
													var childTask = child.fork('./routes/child/basic_mandrill.js');
	  												childTask.send({push_type:'mandrill basic',required_body:body[j],mandrill_api_key:mandrill_credentials.api_key,reference_key:basic_unique_string});
													// end mandrill basic child email
												}else{
													message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: to,form and subject)",reference_key:""});
												}
											}else{
												message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your mandrill api key first",reference_key:""});
											}
											...
											if(!!mandrill_credentials.api_key){
												if(!!from_email && !!to_email && !!subject && !!template_name_text && !!template_content_text){
													...
													// mandrill basic child email
													message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:template_unique_string});
													var childTask = child.fork('./routes/child/template_mandrill.js');
	  												childTask.send({push_type:'mandrill template',required_body:body[j],mandrill_api_key:mandrill_credentials.api_key,reference_key:template_unique_string});
													// end mandrill basic child email
												}else{
													message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: to,form,subject,template name and template content)",reference_key:""});
												}
											}else{
												message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your mandrill api key first",reference_key:""});
											}
										}else{
											message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide valid mandrill email type",reference_key:""});
										}
									}
									...
									for(var sg=0;sg<sg_body.length;sg++){
										...
										if(!!sendgrid_credentials.api_key){
											if(!!from_email && !!to_email && !!subject && !!html_content && !!text_content){
												...
												// mandrill basic child email
												message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:sg_unique_string});
												var childTask = child.fork('./routes/child/sendgrid.js');
  												childTask.send({push_type:'sendgrid',required_body:sg_body[sg],sendgrid_api_key:sendgrid_credentials.api_key,reference_key:sg_unique_string});
												// end mandrill basic child email
											}else{
												message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: to,form,subject,html_content and text_content)",reference_key:""});
											}
										}else{
											message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your sendgrid api key first",reference_key:""});
										}
									}
								}else{
									message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide default email subtype for onetime category",reference_key:""});
								}
							}/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> SMS TYPE >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
									...
									for(var k=0;k<sms_body.length;k++){
										...
										if(!!accountSid && !!authToken){
											if(!!to_country_code && !!to_number && !!from_country_code && !!from_number && !!message){
												...
												message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:sms_unique_string});
												var childTask = child.fork('./routes/child/twilio.js');
												childTask.send({push_type:'twilio sms',required_body:sms_body[k],reference_key:sms_unique_string});
												// end smsm child email
											}else{
												message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters(i.e: country code,to number,from country code,from number and message)",reference_key:""});
											}
										}else{
											message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your twilio authentication first",reference_key:""});
										}
									}
								}else{
									message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide default sms push subtype for onetime category",reference_key:""});
								}
								...
								if(subtype == CONST_PARAM.BASIC){
									...
									for(var m=0;m<web_body.length;m++){
										...
										if(!!html_title && !!html_body && !!user_id){
											...
											message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:web_unique_string});
											...
											connection.query(selectSql,selectparam, (err, rows, fields) => {
												if (err){
										        	...
										        	if(!!subscription_details){
														...
														childTask.send({push_type:'basic webpush',required_body:web_body_data,reference_key:web_unique_string,subscription_details:subscription_details});
														// end smsm child email
										        	}else{
											...
											message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters(i.e: title,body and user id)",reference_key:""});
										}
									}
								}/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> ADVANCE >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
									...
									for(var am=0;am<adv_web_body.length;am++){
										...
										if(!!html_title && !!html_body && !!user_id && !!icon_url && !!badge_url){
											...
											message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:adv_web_unique_string});
											// get user subsciption endpoint 
											let selectSql = 'SELECT * FROM `subscription` WHERE `id`=?';
											let selectparam = [user_id];
											// select query 
											connection.query(selectSql,selectparam, (err, rows, fields) => {
												if (err){
										        	...
										        	if(!!subscription_details){
														...
														childTask.send({push_type:'advance webpush',required_body:adv_web_body_data,reference_key:adv_web_unique_string,subscription_details:subscription_details});
														// end smsm child email
										        	}else{
											        	//message_arr.push({error_key:"No subsciption details not found"});
											        	let insertsql = 'INSERT INTO `push_logs`(`push_type`, `reference_key`, `status`, `json_respone`) VALUES (?,?,?,?)';
											...
											message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters(i.e: title,body,user_id,icon_url and badge_url)",reference_key:""});
										}
									}
									//end advance
								}else{
									message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide default web push subtype for onetime category",reference_key:""});
								}

							}else{
								message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide valid push type for onetime category",reference_key:""});
							}
							...
							if(type == CONST_PARAM.EMAIL){
								...
								if(subtype == CONST_PARAM.MANDRILL){
										...
										if(email_type == CONST_PARAM.BASIC){
											...
											if(!!mandrill_credentials.api_key){
												if(!!from_email && !!to_email && !!subject && !!schedule_time){
													...
													message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:skd_basic_unique_string});	
													...
													connection.query(sql1,params1, (err1, rows1, fields1) => {
												        if (err1){
												        	...
												        	schedule.scheduleJob(skd_basic_unique_string,schedule_time, function(){
																// mandrill basic child email												
																var childTask = child.fork('./routes/child/basic_mandrill.js');
				  												childTask.send({push_type:'schedule mandrill basic',required_body:skd_body_data,mandrill_api_key:mandrill_credentials.api_key,reference_key:skd_basic_unique_string});
																// end mandrill basic child email
															});
												        }					        
												    });											
													...
													message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: to,form,subject and schedule time )",reference_key:""});
												}
											}else{
												message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your mandrill api key first",reference_key:""});
											}
											...
											if(!!mandrill_credentials.api_key){
												if(!!from_email && !!to_email && !!subject && !!schedule_time){
													...
													message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:skd_template_unique_string});	
													//create log before schedule began
													let sql1 = 'INSERT INTO `push_logs`(`push_type`, `reference_key`, `status`, `json_respone`) VALUES (?,?,?,?)';
													...
													connection.query(sql1,params1, (err1, rows1, fields1) => {
												        if (err1){
												        	...
												        	schedule.scheduleJob(skd_template_unique_string,schedule_time, function(){
																// mandrill basic child email												
																var childTask = child.fork('./routes/child/template_mandrill.js');
				  												childTask.send({push_type:'schedule mandrill template',required_body:skd_body_data,mandrill_api_key:mandrill_credentials.api_key,reference_key:skd_template_unique_string});
																// end mandrill basic child email
															});
												        }					        
												    });											
											...
											message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide valid mandrill email type for schedule category",reference_key:""});
										}
									...
									for(var ssg=0;ssg<skd_sg_body.length;ssg++){
										...
										if(!!sendgrid_credentials.api_key){
											if(!!from_email && !!to_email && !!subject && !!html_content && !!text_content && !!schedule_time){
												...
												// mandrill basic child email
												message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:skd_sg_unique_string});
												//create log before schedule began
												let sql1 = 'INSERT INTO `push_logs`(`push_type`, `reference_key`, `status`, `json_respone`) VALUES (?,?,?,?)';
												...
												connection.query(sql1,params1, (err1, rows1, fields1) => {
											        if (err1){
											        	...
											        	schedule.scheduleJob(skd_sg_unique_string,schedule_time, function(){
															...
															var childTask = child.fork('./routes/child/sendgrid.js');
			  												childTask.send({push_type:'schedule sendgrid',required_body:skd_sg_body[ssg],sendgrid_api_key:sendgrid_credentials.api_key,reference_key:skd_sg_unique_string});
															// end mandrill basic child email
														});
											        }					        
											    });	
												...
												message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: to,form,subject,html_content,text_content and schedule_time)",reference_key:""});
											}
										}else{
											message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your sendgrid api key first",reference_key:""});
										}
									...
									message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide valid email push subtype for schedule category",reference_key:""});
								}
							}/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> SMS TYPE >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
							else if(type == CONST_PARAM.SMS){
								var subtype = (pushdata[i].push_subtype) ? pushdata[i].push_subtype : DEFAULT_PARAM.DEFAULT_SMS_SUBTYPE;
								...
								if(subtype == CONST_PARAM.TWILIO){
									...
									for(var sk=0;sk<skd_sms_body.length;sk++){
										...
										if(!!accountSid && !!authToken){
											if(!!to_country_code && !!to_number && !!from_country_code && !!from_number && !!message && !!schedule_time){
												...
												message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:skd_sms_unique_string});
												//create log before schedule began
												let sql1 = 'INSERT INTO `push_logs`(`push_type`, `reference_key`, `status`, `json_respone`) VALUES (?,?,?,?)';
												...
												connection.query(sql1,params1, (err1, rows1, fields1) => {
											        if (err1){
											        	...
											        	schedule.scheduleJob(skd_sms_unique_string,schedule_time, function(){
															// call sms child file	
															var childTask = child.fork('./routes/child/twilio.js');
															childTask.send({push_type:'schedule twilio sms',required_body:skd_sms_body_data,reference_key:skd_sms_unique_string});
															// end smsm child email
														});
											        }					        
											    });
											}else{
												message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters(i.e: country code,to number,from country code,from number,message and schedule time)",reference_key:""});
											}
										}else{
											message_arr.push({error:CONST_PARAM.ERROR_402,success:CONST_PARAM.SUCCESS_0,error_key:"Kindly configure your twilio authentication first",reference_key:""});
										}
									...
									message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide default sms push subtype for schedule",reference_key:""});
								}
								...
								if(subtype == CONST_PARAM.BASIC){
									...
									for(var sm=0;sm<skd_web_body.length;sm++){
										...
										if(!!html_title && !!html_body && !!schedule_time && !!user_id){
											...
											message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:skd_web_unique_string});
											// get user subsciption endpoint 
											let selectSql = 'SELECT * FROM `subscription` WHERE `id`=?';
											let selectparam = [user_id];
											// select query 
														...
														connection.query(sql1,params1, (err1, rows1, fields1) => {
													        if (err1){
																...
																schedule.scheduleJob(skd_web_unique_string,schedule_time, function(res){
																	// call sms child file	
																	var childTask = child.fork('./routes/child/basic_webpush.js');
																	childTask.send({push_type:'schedule webpush',required_body:skd_web_body_data,reference_key:skd_web_unique_string,subscription_details:subscription_details});
																	// end smsm child email
																});
											...
											message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: title,body,user id and schedule time)",reference_key:""});
										}
									}
								}/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> ADVANCE SUBTYPE >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
								else if(subtype == CONST_PARAM.ADVANCE){
									...
									for(var sam=0;sam<skd_adv_web_body.length;sam++){
										...
										if(!!html_title && !!html_body && !!schedule_time && !!user_id && !!icon_url && !!badge_url){
											...
											message_arr.push({error:CONST_PARAM.ERROR_0,success:CONST_PARAM.SUCCESS_200,error_key:"",reference_key:skd_adv_web_unique_string});
											// get user subsciption endpoint 
											let selectSql = 'SELECT * FROM `subscription` WHERE `id`=?';
											let selectparam = [user_id];
											// select query 
														...
														connection.query(sql1,params1, (err1, rows1, fields1) => {
													        if (err1){
																...
																schedule.scheduleJob(skd_adv_web_unique_string,schedule_time, function(res){
																	// call sms child file	
																	var childTask = child.fork('./routes/child/advance_webpush.js');
																	childTask.send({push_type:'schedule advance webpush',required_body:skd_adv_web_body_data,reference_key:skd_adv_web_unique_string,subscription_details:subscription_details});
																	// end smsm child email
																});
											...
											message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide all required parameters.(i.e: title,body,user_id,schedule time, icon_url and badge_url)",reference_key:""});
										}
									}
								}else{
									message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide default web push subtype for schedule category",reference_key:""});
								}

							}else{
								message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide valid push type for schedule category",reference_key:""});
							}
						}else{
							message_arr.push({error:CONST_PARAM.ERROR_400,success:CONST_PARAM.SUCCESS_0,error_key:"Please provide valid push category",reference_key:""});
						}
					}else{
						message_arr.push({error:CONST_PARAM.ERROR_401,success:CONST_PARAM.SUCCESS_0,error_key:"Push category is required",reference_key:""});
					}				
